...
const userProfilePic = "https://placehold.co/36x36/f0f0f0/343a40?text=JM";
        ...
        <Offcanvas.Body className="p-0">
          <Nav className="flex-column">
            ...
            <Nav.Link href="#" className="py-2 px-3 text-dark">
              <span className="me-3"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg></span> Ongoing Transactions
            </Nav.Link>
            <Nav.Link href="#" className="py-2 px-3 text-dark">
              <span className="me-3"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg></span> Sellers
            </Nav.Link>
            <Nav.Link href="#" className="py-2 px-3 text-dark">
