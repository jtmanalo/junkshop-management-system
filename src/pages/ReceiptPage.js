...
function ReceiptPage() {
    ...
    return (
        <div style={{ position: 'relative', padding: '2rem', maxWidth: '800px', margin: '0 auto', border: '1px solid #ccc', borderRadius: '8px', backgroundColor: '#fff', overflowY: 'auto', maxHeight: '80vh' }}>
            <Button
                variant="link"
                onClick={saveAsImage}
            ...
            <div id="receipt-content" style={{ padding: '2rem', textAlign: 'center' }}>
                <h3><strong>{receiptData.branchName.toUpperCase()}</strong></h3>
